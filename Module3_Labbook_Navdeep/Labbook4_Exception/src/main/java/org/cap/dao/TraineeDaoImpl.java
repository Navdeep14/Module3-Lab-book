...
public class TraineeDaoImpl implements ITraineeDao {
	...
	public Boolean delete(int traineeId) {
		 ...
		 if(trainee == null) {
			 throw new TraineeNotFoundException("Trainee not found for id ="+traineeId);
		 }
	...
	public Trainee modify(Trainee trainee) {
		...
		trainee = entityManager.find(Trainee.class, trainee.getTraineeId());
		 if(trainee == null) {
			 throw new TraineeNotFoundException("Trainee not found for id ="+traineeId);
		 }
    ...
    public boolean credentialsCorrect(int id, String password) {
		  User user = new User(2,"Navdeep Tripathi");
